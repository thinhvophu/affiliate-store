...
│   ├── deal-roundup/     # F0015 weekly deal-roundup data-input layer (US00151) — RankedDeal/DroppedDeal model, loadRankedDeals() (reads data/deals/<date>.json, never re-sorts/re-scores), CLI arg parser, summary reporter; sibling of ingest/, shares only the data/deals/ input
