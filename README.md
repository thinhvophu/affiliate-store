...
│   ├── deal-roundup/     # F0015 weekly deal-roundup pipeline (US00151, US00152) — RankedDeal/DroppedDeal model, loadRankedDeals() (reads data/deals/<date>.json, never re-sorts/re-scores), CLI arg parser, summary reporter, plus renderDealPostStub() + writeDealSidecar(); sibling of ingest/, shares only the data/deals/ input
